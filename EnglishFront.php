...
<?php  require_once 'EnglishBack.php'; ?>
...
$result =  $mysqli->query("SELECT * FROM english") or die ($mysqli->error);
...
<div class="row justify-content-center">
        <form action="EnglishBack.php" method="POST">
...
<div class="row justify-content-center">
    ...
    <td>
    <a href="EnglishFront.php?edit=<?php echo $row['id'] ?>" class="btn btn-info">Edit</a> 
    <a href="EnglishBack.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger">Delete</a>
    </td>
    </tr>
<?php endwhile; ?>
    </table>
